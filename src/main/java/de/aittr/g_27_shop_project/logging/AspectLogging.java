...
public class AspectLogging {
  ...
  @Pointcut("execution(* de.aittr.g_27_shop_project.services.jpa.JpaProductService.getAllActiveProducts(..))")
  public void getProducts() {}

  @Before("getProducts()")
  public void beforeGetProduct(JoinPoint joinPoint) {
    logger.info("Вызан метод getAllActiveProducts");
  }

  @Pointcut("execution(* de.aittr.g_27_shop_project.services.jpa.JpaProductService.restoreById(..))")
  public void restore() {}

  @After("restore()")
  public void afterRestore(JoinPoint joinPoint) {
//    joinPoint.getSignature(JoinPoint joinPoint)
    Object[] args = joinPoint.getArgs();
    logger.info(String.format("Метод restoreById вызван с параметром %s", args[0]));
  }

  @Pointcut("execution(* de.aittr.g_27_shop_project.services.jpa.JpaProductService.getActiveProductById(..))")
